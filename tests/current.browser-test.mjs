...
try {
 ...
 for(const key of ['macroArc','openArc','equalRows','stacked','aligned','labelsAfter','shortLabels','longMeters','sourceNarrow','clearTrack','noPeakDots','palette','routingFour','routingBand','routingSpacing','routingPlain','routeNamesNeutral','assignedNumber','noHeadStatus','valuesHidden','valuesReveal','lowMixHome','followsPalette','oneGrip'])assert.equal(audioFace.ott[key],true,key);
