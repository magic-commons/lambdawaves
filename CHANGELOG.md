...
- `b4a3465` 2026-09-25 — REPORT.md wave 126 (the iPad afternoon: pacing, the one-rule AUTO SCALE, the tablet's quality),…
- `8200244` 2026-09-25 — device reports: the third iPad run on the paced build (PACED; 60 fps, 0 held, queue 12–17 ms at…
- `7793a5b` 2026-09-25 — device reports: the fourth iPad run (paced build): every scene at 60 fps, AUTO SCALE within a…
- `d75a278` 2026-09-25 — OPTIMIZATION 2026-09-24 · PACE4 the device report's grid edge: three GRID taps, playing and…
- `4ac17cc` 2026-09-25 — device reports: the fifth iPad run
- `237d771` 2026-09-25 — NEXT-MOVES.md
- `7336237` 2026-09-25 — OPTIMIZATION 2026-09-24 · PACE5 the device report's project open: WAVE DANCER clicked open while…
- `416ac2c` 2026-09-25 — NEXT-MOVES: Josh's yes; wave 129 gains docs/NOTES-FOR-AGENTS.md (the Safari 120 Hz flag and the…
- `b1ae335` 2026-09-25 — device reports: the sixth iPad run
- `a83b708` 2026-09-25 — OPTIMIZATION 2026-09-24 · PACE6 the device report's project open with force=1: it runs over…
- `b2729b2` 2026-09-25 — device reports: the seventh iPad run (the project-open scene skipped again: the URL ran without…
- `41b2092` 2026-09-25 — device reports: the eighth iPad run
- `b3511cf` 2026-09-25 — OPTIMIZATION 2026-09-24 · W127-1 restore() stands a running A/B transition down before it writes…
- `3fdca95` 2026-09-25 — OPTIMIZATION 2026-09-24 · W127-2 a project that opens the modulation window rebuilds it once,…
- `001fb86` 2026-09-25 — OPTIMIZATION 2026-09-24 · W127-3 restore() sizes the notebook once: the layout's nb, not a…
- `3087a06` 2026-09-25 — OPTIMIZATION 2026-09-24 · W127-4 restore() paints the palette once: the file's stops under their…
- `6cbba0c` 2026-09-25 — OPTIMIZATION 2026-09-24 · W127-5 a saved project's open no longer lays the page out twice for…
