/* serialize-bytes.mjs — `__LW.serialize()` bytes on fixed projects (the saved-bytes neutrality read for lane LA).
 *   LW_PORT=8724 GD_PORT=5243 node research/optimization-2026-09-24/probes/LA/serialize-bytes.mjs <tag> */
