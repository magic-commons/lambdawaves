/* serialize-bytes.mjs — `__LW.serialize()` bytes on fixed projects (the saved-bytes neutrality read, copied from lane LA for PACE).
 *   LW_PORT=8724 GD_PORT=5243 node research/optimization-2026-09-24/probes/PACE/serialize-bytes.mjs <tag> */
