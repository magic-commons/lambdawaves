/* lib.mjs — wave 130's copy of lane LA's probe harness (port 8746): one page on the LA gate server, µs timers, the warning dismissed.
...
export const PORT = process.env.LW_PORT || '8746';
