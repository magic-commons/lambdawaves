 ...
 *   H2  THE GOVERNOR.  rack.js' one controller judges the window median of presented frame intervals against the frame
 *       budget and STEPS THE FIELD GRID DOWN THE LADDER (128 → 96 → 64) when the machine is slow.  This is the headline
 ...
 *   H3  AUTO SCALE.  quality.autoScale is moved by ONE time-paced proportional decision (every ≥ 250 ms and 6 presented frames, then held) and multiplies the canvas
